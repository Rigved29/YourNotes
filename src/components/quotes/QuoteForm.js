...
const QuoteForm = (props) => {
 ...
 if(enteredAuthor!=="" && enteredText!==""){
  ...
  props.onAddQuote({ author: enteredAuthor, text: enteredText,method:"post", id:Math.random(),date:(new Date())});
  ...
  return (
    <Fragment>
<Prompt when={isEntering} message={(location)=> "If u leave then all your data will be lost,still u want to leave?"}/>
  <Card>
